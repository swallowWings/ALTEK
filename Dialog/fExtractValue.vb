...
Public Class fExtractValue
    ...
    Private mColidxInTextFile As Integer = 0
    ...
    Sub SetProcessingOptionalIU()
        ...
        Me.gbExtractFromTextFile.Enabled = True
        ...
        If Me.rbValueFromASCIIFiles.Checked = True Then
            ...
            Me.gbExtractFromTextFile.Enabled = False
    ...
    Private Sub rbStartingIndex_CheckedChanged(sender As Object, e As EventArgs) Handles rbStartingIndex.CheckedChanged
        setUIingbExtractFromTextFile()
    End Sub
    Private Sub rbStartingLineText_CheckedChanged(sender As Object, e As EventArgs) Handles rbStartingLineText.CheckedChanged
        setUIingbExtractFromTextFile()
    End Sub
