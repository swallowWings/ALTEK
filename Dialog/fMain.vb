Public Class fMain
    ...
    Private Sub btExtractText_Click(sender As Object, e As EventArgs) Handles btGetText.Click
    ...
    Private Sub btAppendFiles_Click(sender As Object, e As EventArgs) Handles btAppendFiles.Click
        Dim fFP As New fAppendFiles
        fFP.Show()
    End Sub
End Class
