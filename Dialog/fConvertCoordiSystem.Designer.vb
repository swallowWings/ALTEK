...
Partial Class fConvertCoordiSystem
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox3.Text = "** If the source file is ESRI ASC file, it must have a projection file(.prj). If " &
    "you do not have prj file, please define the coordinate system info as Proj4 form" &
    "at." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10)
        '
        'cbFileFormat_input
        '
